        ...
        : Layer("ExampleLayer"), m_CameraController(1280.0f / 720.0f)
{
    ...
    m_ChernoLogoTexture = XEngine::Texture2D::Create(CPP_SRC_DIR"Sandbox/assets/textures/ChernoLogo.png");
...
void ExampleLayer::OnUpdate(XEngine::Timestep ts)
{
    // Update
...
void ExampleLayer::OnEvent(XEngine::Event& e)
{
