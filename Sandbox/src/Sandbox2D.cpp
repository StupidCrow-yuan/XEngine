...
//        XEngine::Renderer2D::DrawRotatedQuad({-1.0f, 0.0f}, {0.8f, 0.8f}, glm::radians(-45.0f), { 0.8f, 0.2f, 0.3f, 1.0f });
        ...
        XEngine::Renderer2D::DrawQuad({ -5.0f, -5.0f, -0.1f }, { 10.0f, 10.0f }, m_CheckboardTexture, 10.0f);
        XEngine::Renderer2D::DrawQuad({ -0.50f, -0.50f, 0.0f }, { 1.0f, 1.0f }, m_CheckboardTexture, 20.0f);
