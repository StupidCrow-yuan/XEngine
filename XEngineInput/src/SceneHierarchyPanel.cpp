...
namespace XEngine {
    ...
    void SceneHierarchyPanel::OnImGuiRender()
    {
        ...
        if (ImGui::BeginPopupContextWindow(0, 1, false))
        {
            if (ImGui::MenuItem("Create Empty Entity"))
                m_Context->CreateEntity("Enpty Entity");
    ...
    void SceneHierarchyPanel::DrawComponents(Entity entity)
    {
        ...
        if (entity.HasComponent<SpriteRendererComponent>()) {
            ...
            bool open = ImGui::TreeNodeEx((void *) typeid(SpriteRendererComponent).hash_code(), treeNodeFlags,
                                          "Sprite Renderer");
            ...
            if (removeComponent)
            {
                entity.RevomeComponent<SpriteRendererComponent>();
            }
        }
    }
}